...
const frame: React.CSSProperties = { width: "var(--ll-phone-width)", height: "var(--ll-phone-height)", background: "var(--ll-surface)", borderRadius: 38, overflow: "hidden", boxShadow: "0 28px 70px rgba(25,28,30,.28)", position: "relative", display: "flex", flexDirection: "column" };
const nav: React.CSSProperties = { display: "flex", background: "var(--ll-surface-container-lowest)", boxShadow: "var(--ll-shadow-bottom-nav)", padding: "6px 4px 9px", flex: "none" };
